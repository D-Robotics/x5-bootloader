...
if [ -z "${HR_KERNEL_OUTPUT_DIR}" ]; then
	kernel_out_dir=${HR_TOP_DIR}/kernel
else
	kernel_out_dir=${HR_KERNEL_OUTPUT_DIR}
fi
"${kernel_out_dir}"/usr/gen_init_cpio $timestamp $cpio_list > $output
